<div class="row"><h1>Add a new store</h1></div>
	...
	<div class="row">
		<div class="span6">
			...
			<div class="row">
				...
				<div class="span3"><input id="shop_name"  name="shop_name" type="text" class="form-control" required="true" /></div>
			</div><br />
			<div class="row">
				<div class="span2"><label for="address">Street name:</label></div>
				<div class="span3"><input id="address"  name="street_name" type="text" class="form-control" required="true" /></div>
			</div><br />
			<div class="row">
				<div class="span2"><label for="city">City:</label></div>
				<div class="span3"><input id="city"  name="city" type="text" class="form-control" required="true" /></div>
			</div><br />
			<div class="row">
				<div class="span2"><label for="postal_code">Postal code:</label></div>
				<div class="span3"><input id="postal_code"  name="postal_code" type="text" class="form-control" required="true" /></div>
			</div><br />
			<div class="row">
		...
		<div class="span6">
			...
			<input id="latitude" name="lat" value="55.6760968" type="hidden">
			<input id="longitude" name="long" value="12.568337100000008" type="hidden">
		</div>
    </div>
	<div class="row">
		<div class="span6">
			...
			<div class="row">
				...
				<div class="span3"><input id="contact_name" name="contact_name" type="text" class="form-control" required="true" /></div>
			</div><br />
			<div class="row">
				<div class="span2"><label for="phone_number">Phone number:</label></div>
				<div class="span3"><input id="phone_number" name="phone_number" type="text" class="form-control" required="true" /></div>
			</div><br />
			<div class="row">
				<div class="span2"><label for="email_address">Email address:</label></div>
				<div class="span3"><input id="email_address" name="email_address" type="email" class="form-control" required="true" /></div>
			</div><br />
		</div>
		<div class="span6">
			<h3>Configuration</h3>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		initialize();
		var location = new google.maps.LatLng(55.6760968, 12.568337100000008);
